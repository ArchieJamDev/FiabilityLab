  ...
  private = list(
    ...
    .run = function() {
      ...
      irr_body <- paste0(
        ...
        p(tr(
          "Chance-corrected agreement for categorical (nominal) ratings: Cohen's Kappa for exactly 2 raters (Cohen, 1960), Fleiss' Kappa for more than 2. Both can be paradoxically low even when raw agreement is high, whenever one category is much more common than the others — the “kappa paradox” (Gwet, 2014).",
          "Acuerdo corregido por azar para calificaciones categóricas (nominales): el Kappa de Cohen para exactamente 2 jueces (Cohen, 1960), el Kappa de Fleiss para más de 2. Ambos pueden ser paradójicamente bajos aun con acuerdo bruto alto, cuando una categoría es mucho más común que las demás — la “paradoja del kappa” (Gwet, 2014)."
        )),
        h4("Gwet's AC1 / AC2"),
        p(tr(
